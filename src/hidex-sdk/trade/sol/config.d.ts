...
export declare const SEED_TRADE_NONCE = "trade_nonce_data";
...
export declare const Trading_Service_Providers: PublicKey[];
export declare const BLOXROUTE: PublicKey;
export declare const FLASHROUTR: PublicKey;
...
export declare const SOLANA_MAX_TX_SERIALIZE_SIGN = 600;
...
export declare const DEFAULD_SOLANA_PRIORITY: number;
