        ...
        '导入成功，' +
          `账号地址为：${
            value.split(' ').length === 12
              ? '【BSC】: ' + walletInfo.accountList[0]['BSC'].address + ', 【SOL】: ' + walletInfo.accountList[0]['SOLANA']?.address
              : walletInfo.accountList[0]['BSC']
              ? walletInfo.accountList[0]['BSC'].address
              : walletInfo.accountList[0]['SOLANA'].address
          }`
      );
      setInputValue('');
    } catch (error: any) {
